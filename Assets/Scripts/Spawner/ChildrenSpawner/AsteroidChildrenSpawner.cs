...
{
    public class AsteroidChildrenSpawner: ChildrenSpawner
    {
        private GameObjectSpawner _spawner;
        private AsteroidsDataStorage _dataStorage;

        public AsteroidChildrenSpawner(GameObjectSpawner spawner, AsteroidsDataStorage dataStorage)
        {
            _spawner = spawner;
        ...
        public override void SpawnChildren(IComponentsStorage componentsStorage)
        {
            ...
            if ((data != null))
            {
                ...
                _spawner.SpawnAsteroid(newTransform1, data);
                _spawner.SpawnAsteroid(newTransform2, data);
            }
        }
    }
}